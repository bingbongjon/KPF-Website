    ...
    barba.init({
        ...
        views: [{
            ...
            beforeEnter({ next }) {
                ...
                let notchScript = document.createElement('script');
                let emailScript = document.createElement('script');

                navbarScript.src = '../assets/js/navbar.js';
                notchScript.src = '../assets/js/notch_width.js';
                emailScript.src = '../assets/js/email.js';

                next.container.appendChild(navbarScript);
                next.container.appendChild(notchScript);
                next.container.appendChild(emailScript);
            }
        }],
...
function initCookieViews() {
    ...
    if (Cookies.get("view") == "columns") {
        ...
        $('#archive .grid-rows-part').removeClass('visible');
        $('#archive .grid-columns-part').addClass('visible');
        scroll.update();
        ScrollTrigger.refresh();
    }
}
...
function initScrolltriggerAnimations() {
    ...
    if (document.querySelector(".newsletter-badge")) {
        // Scrolltrigger Animation : Awwwards
        $(".newsletter-badge").each(function(index) {
            let triggerElement = $(this);
            let targetElement = $(".newsletter-badge svg:nth-child(1)");
    ...
    ScrollTrigger.matchMedia({
        ...
        "(min-width: 721px)": function() {
            ...
            if (document.querySelector(".community-image .single-community-image")) {
                // Scrolltrigger Animation : Community 
                $(".community-image .single-community-image").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".community-image .arrow");
            ...
            if (document.querySelector(".apply-image .single-apply-image")) {
                // Scrolltrigger Animation : Community 
                $(".apply-image .single-apply-image").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".apply-image .arrow");
            ...
            if (document.querySelector(".archive-image")) {
                // Scrolltrigger Animation : Community 
                $(".archive-image").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".archive-image .arrow");
            ...
            if (document.querySelector(".archive-image")) {
                // Scrolltrigger Animation : Community 
                $("#concert-schedule .archive-image").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".archive-image .arrow");
            ...
            if (document.querySelector(".sponsors-image")) {
                // Scrolltrigger Animation : Community 
                $(".sponsors-image").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".sponsors-image .arrow");
            ...
            if (document.querySelector(".partners-image")) {
                // Scrolltrigger Animation : Community 
                $(".partners-image").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".partners-image .arrow");
            ...
            if (document.querySelector(".pictures-header")) {
                // Scrolltrigger Animation : Community 
                $(".apply-image").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".apply-image .arrow");
            ...
            if (document.querySelector(".pictures-header")) {
                // Scrolltrigger Animation : Community 
                $(".block_4-second").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".apply-image-second .arrow");
            ...
            if (document.querySelector(".community-donate")) {
                // Scrolltrigger Animation : Community Services BG
                $(".community-donate").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".community-header, .line-globe, .community-donate");
            ...
            if (document.querySelector("#pictures .community-donate")) {
                // Scrolltrigger Animation : Community Services BG
                $(".community-donate").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".community-header, .footer-rounded-div .rounded-div");
            ...
            if (document.querySelector("#videos .community-donate")) {
                // Scrolltrigger Animation : Community Services BG
                $(".block-device.block_2").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".block-device.block_2");
            ...
            if (document.querySelector(".apply-intro")) {
                // Scrolltrigger Animation : Community Services BG
                $(".apply-intro").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".apply-header, .line-globe, .apply-intro");
            ...
            if (document.querySelector(".archive-header")) {
                // Scrolltrigger Animation : Community Services BG
                $(".section-wrap-archives").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".archive-header, .section-divider-first, .section-wrap-archives");
            ...
            if (document.querySelector(".apply-register")) {
                // Scrolltrigger Animation : Community Services BG
                $(".apply-register").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".apply-register, .footer-rounded-div .rounded-div");
            ...
            if (document.querySelector(".contact-header")) {
                // Scrolltrigger Animation : Community Services BG
                $(".contact-details").each(function(index) {
                    let triggerElement = $(this);
                    let targetElement = $(".contact-details");
...
// iFrame Cursor Behaviour
let mouseCursor = document.querySelector("#cursor");
var aboutTextIframe = document.querySelector(".article-container iframe");
var videoIframe = document.querySelector(".video-container iframe");

// aboutTextIframe.addEventListener("mouseover", function() {
//     mouseCursor.style.display = 'none';
// })
// aboutTextIframe.addEventListener("mouseleave", function() {
//     mouseCursor.style.display = 'block';
// })
// videoIframe.addEventListener("mouseover", function() {
//     mouseCursor.style.display = 'none';
// })
...
var donateInfo = document.getElementById("donate-info");

$(document).ready(function() {
    setTimeout(function() {
        if (window.location.href.split('?').pop() == 'donate-info') {
            const slider = document.querySelector('#donate-info');
            const header = document.querySelector('.default-header');
            const footer = document.querySelector('.footer-wrap');
            scroll.scrollTo(slider);
        }
        if (window.location.href.split('?').pop() == 'kpf-2021') {
            const slider = document.querySelector('#kpf-2021-section');
            scroll.scrollTo(slider);
        }
        if (window.location.href.split('?').pop() == 'kpf-2020') {
            const slider = document.querySelector('#kpf-2020-section');
            scroll.scrollTo(slider);
        }
        if (window.location.href.split('?').pop() == 'kpf-2019') {
            const slider = document.querySelector('#kpf-2019-section');
            scroll.scrollTo(slider);
        }
        if (window.location.href.split('?').pop() == 'kpf-2018') {
            const slider = document.querySelector('#kpf-2018-section');
            scroll.scrollTo(slider);
        }
    }, 1500);
});

// const kpf2021Section = document.querySelector('#kpf-2021-section');
// const kpf2020Section = document.querySelector('#kpf-2020-section');
// const kpf2019Section = document.querySelector('#kpf-2019-section');
// const kpf2018Section = document.querySelector('#kpf-2018-section');

// var scrollToHere = kpf2021Section.offsetTop;


// $('#kpf-2021-link').on('click', function() {
//     scroll.destroy();
//     scroll.scrollTo(kpf2021Section)
// });
// $('#kpf-2020-link').on('click', function() {
//     scroll.destroy();
//     scroll.scrollTo(kpf2020Section)
// });
// $('#kpf-2019-link').on('click', function() {
//     scroll.destroy();
//     scroll.scrollTo(kpf2019Section)
// });
// $('#kpf-2018-link').on('click', function() {
//     scroll.destroy();
//     scroll.scrollTo(kpf2018Section)
// });